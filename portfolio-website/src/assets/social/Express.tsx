...
export function Expressjs(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      <path
        fill="currentColor"
        d="M20.493 6.725c.256-.334.652-.53 1.073-.53h.34l-4.392 5.743L22 17.803h-.34a1.35 1.35 0 0 1-1.073-.53l-3.576-4.676l-3.577 4.676a1.35 1.35 0 0 1-1.072.53h-.34l4.485-5.865l-4.391-5.743h.34c.42 0 .817.196 1.072.53l3.482 4.554z"></path>
      <path
        fill="currentColor"
        fillRule="evenodd"
