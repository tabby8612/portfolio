...
export default function Hero() {
  return (
    <div className="flex my-40 w-[85vw] mx-auto text-5xl gap-3">
      <div
        id="intro-text"
      ...
      <div
        ...
        />
        <div className="bg-black rounded-xl absolute -top-9 right-35 py-6 px-6 text-amber-300 text-6xl">
          <CupStarBold />
        </div>
        <div className="bg-black absolute top-20 -left-10 rounded-xl flex justify-center w-44 py-2 gap-3">
          <p className="ml-2 font-bold text-blue-400 text-5xl">12</p>
          <p className="text-white text-[20px] my-auto text-xl">Years of Success</p>
        </div>
        <div className="bg-black absolute bottom-6 right-8 rounded-xl flex justify-center w-60 py-3 gap-3">
          <p className="ml-2 font-bold text-blue-400 text-5xl">800+</p>
          <p className="text-[20px] text-white">Projects Completed</p>
        </div>
